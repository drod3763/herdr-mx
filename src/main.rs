...
[remote]
# manage_ssh_config is accepted for upstream config compatibility; herdr-mx does not
# yet consume it (keepalive/connection-reuse handling differs — see DIVERGENCE.md).
