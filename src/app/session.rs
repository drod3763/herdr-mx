...
enum SessionSaveJob {
    Clear,
    Save {
        // Boxed: mx's SessionSnapshot (remote registry, pane-id aliases) makes this variant
        // large enough to trip clippy::large_enum_variant next to the data-free `Clear`.
